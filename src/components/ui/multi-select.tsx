  ...
  return (
    <div ref={ref} className={cn('flex flex-wrap gap-1 p-1 py-2 border border-muted rounded-lg bg-background', className)} {...props}>
      {value.map((item, index) => (
        <Badge key={item} className={cn('px-2 rounded-xl flex items-center gap-1', activeIndex === index && 'ring-2 ring-muted-foreground ')} variant={'secondary'}>
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <CommandPrimitive.Input
        ...
        className={cn('ml-2 bg-transparent outline-none placeholder:text-muted-foreground flex-1', className, activeIndex !== -1 && 'caret-transparent')}
      />
    );
  },
);
...
export { MultiSelectorComponent, MultiSelector, MultiSelectorTrigger, MultiSelectorInput, MultiSelectorContent, MultiSelectorList, MultiSelectorItem };
